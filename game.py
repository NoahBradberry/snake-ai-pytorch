...
class SnakeGameAI:
    ...
    def play_step(self, action):
        ...
        # Place new food or increase score
    ...
    def _update_ui(self):
        ...
        for pt in self.snake:
            ...
            pygame.draw.rect(self.display, BLUE2, pygame.Rect(pt.x+4, pt.y+4, self.block_size-8, self.block_size-8))
    ...
    def _move(self, action):
        # [straight, right, left] -> new direction
